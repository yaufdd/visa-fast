...
const currentVersion = "2026.04.2"
...
— поставщик облачного ИИ-сервиса ООО «Яндекс.Облако» (Yandex Cloud) —
  для перевода свободных полей на английский язык, формирования
  программы поездки и распознавания сканов билетов и ваучеров.
  Обработка осуществляется на серверах, расположенных на территории
